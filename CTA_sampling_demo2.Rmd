...
```{r}
table_raw <- html_elements(html, css = 'table.sortable:nth-child(30)')
...
```{r, eval=FALSE}
#It does not work
cookies_tick1 <- driver$findElement(using = "css", value = "#uoe-consent-setting-2")

cookies_tick1$clickElement()

Sys.sleep(1) # give it some time

cookies_tick2 <- driver$findElement(using = "css", value = "#uoe-consent-setting-4")
...
agree_button <- driver$findElement(using = "xpath", value = '/html/body/div[2]/div[2]/div[3]/span/div/div/div/div[3]/div[1]/button[2]/div')
...
```{r, eval = FALSE, echo = TRUE}
first_link <- driver$findElement(using = "xpath", value = '//*[@id="gsr"]')
